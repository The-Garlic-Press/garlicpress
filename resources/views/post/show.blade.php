...
@section('content')
  ...
  <div class="card my-4">
    ...
    <div class="card-body">
      <big>
        <a target="_blank" href="https://nanex.co/exchange/GRLCNANO" style="text-decoration: none; color: black;">
          <p style="text-align: center;">Buy and sell your Garlic on</p>
          <img width="298px" height="118" src="https://nanex.co/assets/logo.svg"></img>
        </a>
      </big>
    </div>
  </div>
      ...
      <big>Looking for a pool?<br>
        ...
        See you soon.
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
              <big>
                GarliChurch: The first church of Garlicoin.
          ...
          <div class="card my-4">
            <h5 class="card-header">Advertisement</h5>
            <div class="card-body">
              <big>Person who read this advertisement infinite gay unless they watch Puffycheeses. Reflect all no u, destroy all shields and reverse all reverse cards. <a href="https://goo.gl/G2rBFk" target="_blank">https://www.twitch.tv/puffycheeses</a></big>
            </div>
          </div>
          <div class="card my-4">
            <h5 class="card-header">Advertisement</h5>
            <div class="card-body">
              <big><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script></big>
